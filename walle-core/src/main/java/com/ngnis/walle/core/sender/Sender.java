...
public class Sender {
    ...
    public <T> PojoResult<T> send(AddressDTO address, Message message, Class<T> responseType) {
        // 参数检查
    ...
    private void check(AddressDTO address, Message message, Class<?> responseType) {
    ...
    private String getUrl(AddressDTO address) {
